(function() {
  ...
  exports.format = function(parsed) {
    var auth, hash, host, k, path, port, query, v, _ref, _ref1, _ref2;
    host = parsed.host || parsed.hosts[0].host;
    port = parsed.port || parsed.hosts[0].port;
    port = STANDARD_PORT[parsed.protocol] === port ? '' : ':' + port;
    auth = (((_ref = parsed.auth) != null ? _ref.user : void 0) != null) && (((_ref1 = parsed.auth) != null ? _ref1.password : void 0) != null) ? encodeURIComponent(parsed.auth.user) + ':' + encodeURIComponent(parsed.auth.password) + '@' : '';
